            ...
            <div class="page-content-wrapper ">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Dispatch Entry</h4>
                        </div>
                    </div>
                </div>
                <div class="card m-b-30">
                    ...
                    <div class="card-body">
                        ...
                        @include('partials.view', [$contract])
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="card-body bpv-form">
                                ...
                                <form
                                    ...
                                    <div class="form-inline col-md-12">
                                        ...
                                        <div class="form-group col-md-2-5">
                                            <h6 class="light-dark w-100">Total Quantity<span style="color: red">*</span>

                                                <input type="number" class="form-control" name="total_qty" id="total_qty"
                                                       value="{{ $totalQuantity }}"
                                                       placeholder="" maxlength="70" disabled>
                                        </div>
                                        <div class="form-group col-md-2-5">
                                            <h6 class="light-dark w-100">Dispatched Quantity<span style="color: red">*</span>

                                                <input type="number" class="form-control" name="dispatched_qty" id="dispatched_qty"
                                                       value="{{  $dispatchedQty }}"
                                                       placeholder="" maxlength="70" disabled>
                                        </div>

                                        <div class="form-group col-md-2-5">
                                            <h6 class="light-dark w-100">Balance Quantity<span style="color: red">*</span>
                                    ...
                                    <div class="card-body">
                                        <table class="table table-hover subject-table">
                                            ...
                                            <tr id="row_{{ $contract->id }}">
                                                <td>{{ $dispatch->contract_id }}</td>
                                                <td width="150">{{ $dispatch->lot_no }}</td>
                                                <td width="200">{{ $dispatch->dispatch_quantity }}</td>
                                                <td>{{ $dispatch->factory_weight }}</td>
                                                <td>{{ $dispatch->moisture }}</td>
                                                <td>{{ $dispatch->trash }}</td>
                                                <td>{{ $dispatch->tare }}</td>
                                                <td>{{ $dispatch->net_weight }}</td>

                                                <td width="150">
                                                    <a href="{{ route('dispatch.dispatch-entry', ['id' => $dispatch->id]) }}"
                                                       title="Enter Mill Weight" ><i class="fa fa-pencil"></i></a>
                                                    <a href="{{ route('mill-weight.create', ['id' => $dispatch->id]) }}"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#tare,#moisture,trash",).focusout(function() {
            let moisture = $("#moisture").val() ? parseInt($("#moisture").val()) : 0;
            let trash = $("#trash").val() ? parseInt($("#trash").val()) : 0;
            let tare = $("#tare").val() ? parseInt($("#tare").val()) : 0;

            let deduction = parseInt(moisture + trash + tare)
    ...
    let balanceQty = $("#balance_qty").val();
