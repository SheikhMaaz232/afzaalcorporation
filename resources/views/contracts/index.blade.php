                                ...
                                <div class="page-title-box">
                                    <div class="btn-group float-right">
                                        <ol class="breadcrumb hide-phone p-0 m-0">
                                            ...
                                            <li class="breadcrumb-item active">List Of Contracts</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">List Of Contracts</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        <form action="{{ route('contracts.list') }}" method="get" id="form-search">
                                            <div class="row">
                                                <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    <span class="input-group-prepend" style="margin-top: 0px">
                                                        <a href="{{ route('contracts.list') }}" class="btn btn-primary"
                                                    ...
                                                    <tr id="row_{{ $contract->id }}">
                                                        ...
                                                        <td width="150">
                                                            ...
                                                            <a href="#" title="Delete"><i class="fa fa-trash-o delete"
                                                                    data-id="{{ $contract->id }}"></i></a>
                                                            <a href="{{ route('contracts.print', ['id' => $contract->id]) }}" target="_blank" title="Print"><i class="fa fa-print-o fa-print"
                                                                    data-id="{{ $contract->id }}"></i></a>
                                                                    <a href="#" data-toggle="modal" data-target="#myModal" title="Send Email"><i class="fa fa-envelope"
                                                                        data-id="{{ $contract->id }}"></i></a>
